...
class STOG(Model):
    ...
    def mimick_test(self):
        ...
        dataset_reader = load_dataset_reader('SIG', word_splitter=word_splitter)
    ...
    def prepare_batch_input(self, batch):
        ...
        # TODO: The following change can be done in sig.py.
        ...
        # TODO: The following computation can be done in sig.py.
        # Get the parser mask.
