import torch
from sig_parser.data import END, UNK
from sig_parser.SIGGraph import is_attr_or_abs_form
...
def search_by_batch(model, beams, mem_dict):
    ...
    while True:
        ...
        state_dict, results, alignment_weight = model.decode_step(inp, state_dict, cur_mem_dict, offset, beams[0].beam_size)
