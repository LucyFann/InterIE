...
from elit.common.dataset import PrefetchDataLoader, SamplerBuilder
from elit.common.transform import VocabDict
from elit.components.sig.sig_parser.graph_sig_decoder import GraphAbstractMeaningRepresentationDecoder
from elit.components.sig.sig_parser.graph_parser import GraphAbstractMeaningRepresentationParser
from elit.components.sig.sig_parser.postprocess import PostProcessor
from elit.components.sig.sig_parser.work import parse_batch
from elit.components.mtl.tasks import Task
from elit.datasets.parsing.sig import batchify, get_concepts
from elit.layers.scalar_mix import ScalarMixWithDropoutBuilder
from elit.metrics.sig.smatch_eval import SmatchScores, get_sig_utils
...
from elit.common.util import merge_list_of_dict, merge_locals_kwargs
...
class GraphAbstractMeaningRepresentationParsing(Task, GraphAbstractMeaningRepresentationParser):
    ...
    def __init__(self,
        ...
        utils_dir = get_resource(get_sig_utils(sig_version))
    ...
    def prediction_to_result(self, prediction: Dict[str, Any], batch: Dict[str, Any]) -> List:
        ...
        for concept, relation, score in zip(prediction['concept'], prediction['relation'], prediction['score']):
            sig = pp.to_sig(concept, relation)
            sig_graph = SIGGraph(sig)
