...
from elit.components.sig.sig_parser.data import NIL
from elit.components.sig.sig_parser.utils import compute_f_by_tensor
from elit.components.sig.sig_parser.transformer import MultiheadAttention
from elit.components.sig.sig_parser.utils import label_smoothed_nll_loss
...
class DecodeLayer(nn.Module):
    ...
    def forward(self, probe, snt_state, graph_state,
        ...
        Args:
            ...
            snt_padding_mask:
            graph_padding_mask: [DUM] + x + [END] != concept_pad_idx, where x is the BFS order of SIG concepts
