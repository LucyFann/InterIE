...
class SIG(object):
    ...
    def parse_SIG_line(line):
            ...
            if c == "\"":
                ...
                if state == 1:
                    ...
                    if node_name in node_dict:
                        print("Duplicate node name ", node_name, " in parsing SIG", file=ERROR_LOG)
                        return None
                    ...
                    print("Error in parsing SIG", line[0:i + 1], file=ERROR_LOG)
                    return None
                state = 3
            elif c == ")":
                if in_quote:
        ...
        result_sig = SIG(node_name_list, node_value_list, relation_list, attribute_list)
        return result_sig

# test SIG parsing
# run by sig.py [file containing SIG]
...
if __name__ == "__main__":
    ...
    for line in open(sys.argv[1]):
        ...
        if cur_line == "" or cur_line.startswith("#"):
            continue
        print("SIG", sig_count, file=DEBUG_LOG)
