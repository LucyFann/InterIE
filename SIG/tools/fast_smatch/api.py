...
def _smatch(cur_sig1, cur_sig2, n_iter):
    clear_match_triple_dict()

    sig1 = SIG.parse_SIG_line(cur_sig1)
    sig2 = SIG.parse_SIG_line(cur_sig2)
    prefix1 = "a"
    prefix2 = "b"
...
def smatch(cur_sig1, cur_sig2, n_iter=5):
    best_match_num, test_triple_num, gold_triple_num = _smatch(cur_sig1, cur_sig2, n_iter)
...
class SmatchScorer(object):
    ...
    def update(self, cur_sig1, cur_sig2):
        best_match_num, test_triple_num, gold_triple_num = _smatch(cur_sig1, cur_sig2, self.n_iter)
