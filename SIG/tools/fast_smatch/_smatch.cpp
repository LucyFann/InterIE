...
#define __PYX_HAVE__fast_smatch___smatch
#define __PYX_HAVE_API__fast_smatch___smatch
#include <utility>
#include "ios"
#include "new"
#include "stdexcept"
...
/*--- Type declarations ---*/
struct __pyx_opt_args_11fast_smatch_7_smatch_compute_match;
struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_gain;
struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_match;

/* "fast_smatch/_smatch.pyx":202
 * 
...
/* Module declarations from 'fast_smatch._smatch' */
static void __pyx_f_11fast_smatch_7_smatch_smart_init_mapping(std::vector<std::unordered_set<int> >  const &, PyObject *, PyObject *, std::vector<int>  &); /*proto*/
static void __pyx_f_11fast_smatch_7_smatch_random_init_mapping(std::vector<std::unordered_set<int> >  const &, std::vector<int>  &); /*proto*/
static void __pyx_f_11fast_smatch_7_smatch_compute_pool(PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, std::vector<std::unordered_set<int> >  &, std::unordered_map<int,std::unordered_map<int,int> >  &); /*proto*/
static int __pyx_f_11fast_smatch_7_smatch_compute_match(std::vector<int>  const &, std::unordered_map<int,std::unordered_map<int,int> >  &, struct __pyx_opt_args_11fast_smatch_7_smatch_compute_match *__pyx_optional_args); /*proto*/
static int __pyx_f_11fast_smatch_7_smatch_get_best_gain(std::vector<int>  &, std::vector<std::unordered_set<int> >  &, std::unordered_map<int,std::unordered_map<int,int> >  &, int, int, std::vector<int>  &, struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_gain *__pyx_optional_args); /*proto*/
static void __pyx_f_11fast_smatch_7_smatch_remove_zero_alignments(std::vector<int>  &, std::unordered_map<int,std::unordered_map<int,int> >  &); /*proto*/
static PyObject *__pyx_f_11fast_smatch_7_smatch_get_best_match(PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_match *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "fast_smatch._smatch"
extern int __pyx_module_is_main_fast_smatch___smatch;
int __pyx_module_is_main_fast_smatch___smatch = 0;

/* Implementation of 'fast_smatch._smatch' */
...
static const char __pyx_k_fast_smatch__smatch[] = "fast_smatch._smatch";
...
static PyObject *__pyx_n_s_fast_smatch__smatch;
...
static PyObject *__pyx_pf_11fast_smatch_7_smatch_get_best_match(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_instance1, PyObject *__pyx_v_attribute1, PyObject *__pyx_v_relation1, PyObject *__pyx_v_instance2, PyObject *__pyx_v_attribute2, PyObject *__pyx_v_relation2, PyObject *__pyx_v_prefix1, PyObject *__pyx_v_prefix2, PyObject *__pyx_v_iteration_num, PyObject *__pyx_v_verbose); /* proto */
static PyObject *__pyx_pf_11fast_smatch_7_smatch_2clear_match_triple_dict(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_11fast_smatch_7_smatch_4compute_f(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_match_num, PyObject *__pyx_v_test_num, PyObject *__pyx_v_gold_num, PyObject *__pyx_v_verbose); /* proto */
...
static void __pyx_f_11fast_smatch_7_smatch_smart_init_mapping(std::vector<std::unordered_set<int> >  const &__pyx_v_candidate_mapping, PyObject *__pyx_v_instance1, PyObject *__pyx_v_instance2, std::vector<int>  &__pyx_v_result) {
  ...
  __Pyx_FakeReference<std::unordered_set<int> > __pyx_t_6;
  Py_ssize_t __pyx_t_7;
  int __pyx_t_8;
  PyObject *(*__pyx_t_9)(PyObject *);
  int __pyx_t_10;
  std::vector<int> ::iterator __pyx_t_11;
  __Pyx_FakeReference<std::unordered_set<int> > __pyx_t_12;
  std::unordered_set<int> ::iterator __pyx_t_13;
  std::unordered_set<int>  *__pyx_t_14;
  PyObject *__pyx_t_15 = NULL;
  __Pyx_RefNannySetupContext("smart_init_mapping", 0);

  /* "fast_smatch/_smatch.pyx":43
 * 
 *     """
 *     random.seed()             # <<<<<<<<<<<<<<
 ...
 */
    try {
      __pyx_t_6 = __pyx_v_candidate_mapping.at(__pyx_v_i);
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 49, __pyx_L1_error)
    }
    __pyx_t_1 = __pyx_convert_unordered_set_to_py_int(__pyx_t_6); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 49, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_XDECREF_SET(__pyx_v_candidates, __pyx_t_1);
    __pyx_t_1 = 0;

    /* "fast_smatch/_smatch.pyx":50
 *     for i in range(len(candidate_mapping)):
 *         candidates = candidate_mapping.at(i)
 *         if len(candidates) == 0:             # <<<<<<<<<<<<<<
 *             # no possible mapping
 *             result.push_back(-1)
 */
    __pyx_t_7 = PyObject_Length(__pyx_v_candidates); if (unlikely(__pyx_t_7 == ((Py_ssize_t)-1))) __PYX_ERR(0, 50, __pyx_L1_error)
    __pyx_t_8 = ((__pyx_t_7 == 0) != 0);
    if (__pyx_t_8) {

      /* "fast_smatch/_smatch.pyx":52
 *         if len(candidates) == 0:
 *             # no possible mapping
 *             result.push_back(-1)             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    if (likely(PyList_CheckExact(__pyx_v_candidates)) || PyTuple_CheckExact(__pyx_v_candidates)) {
      __pyx_t_3 = __pyx_v_candidates; __Pyx_INCREF(__pyx_t_3); __pyx_t_7 = 0;
      __pyx_t_9 = NULL;
    } else {
      __pyx_t_7 = -1; __pyx_t_3 = PyObject_GetIter(__pyx_v_candidates); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_9 = Py_TYPE(__pyx_t_3)->tp_iternext; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 56, __pyx_L1_error)
    }
    for (;;) {
      if (likely(!__pyx_t_9)) {
        if (likely(PyList_CheckExact(__pyx_t_3))) {
          ...
          __pyx_t_1 = PyList_GET_ITEM(__pyx_t_3, __pyx_t_7); __Pyx_INCREF(__pyx_t_1); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 56, __pyx_L1_error)
          #else
          __pyx_t_1 = PySequence_ITEM(__pyx_t_3, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          #endif
        } else {
          if (__pyx_t_7 >= PyTuple_GET_SIZE(__pyx_t_3)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_3, __pyx_t_7); __Pyx_INCREF(__pyx_t_1); __pyx_t_7++; if (unlikely(0 < 0)) __PYX_ERR(0, 56, __pyx_L1_error)
          #else
          __pyx_t_1 = PySequence_ITEM(__pyx_t_3, __pyx_t_7); __pyx_t_7++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          #endif
      ...
      __pyx_t_10 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_v_node_index = __pyx_t_10;

      /* "fast_smatch/_smatch.pyx":57
 *         value1 = instance1[i][2]
 *         for node_index in candidates:
 *             value2 = instance2[node_index][2]             # <<<<<<<<<<<<<<
 *             # find the first instance triple match in the candidates
 ...
 */
        __pyx_t_8 = ((__pyx_v_matched_dict.count(__pyx_v_node_index) == 0) != 0);
        if (__pyx_t_8) {

          /* "fast_smatch/_smatch.pyx":62
 *             if value1 == value2:
 *                 if matched_dict.count(node_index) == 0:
 *                     result.push_back(node_index)             # <<<<<<<<<<<<<<
 *                     matched_dict.insert(node_index)
 ...
 *         if len(result) == i:
 */
          __pyx_v_matched_dict.insert(__pyx_v_node_index);

          /* "fast_smatch/_smatch.pyx":64
 *                     result.push_back(node_index)
 *                     matched_dict.insert(node_index)
 *                     break             # <<<<<<<<<<<<<<
 *         if len(result) == i:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_7 = PyObject_Length(__pyx_t_3); if (unlikely(__pyx_t_7 == ((Py_ssize_t)-1))) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_8 = ((__pyx_t_7 == __pyx_v_i) != 0);
    if (__pyx_t_8) {

      /* "fast_smatch/_smatch.pyx":66
 *                     break
 *         if len(result) == i:
 *             no_word_match.push_back(i)             # <<<<<<<<<<<<<<
 *             result.push_back(-1)
 ...
 *         if len(candidates) > 0:
 */
  __pyx_t_11 = __pyx_v_no_word_match.begin();
  for (;;) {
    if (!(__pyx_t_11 != __pyx_v_no_word_match.end())) break;
    __pyx_t_10 = *__pyx_t_11;
    ++__pyx_t_11;
    __pyx_v_i = __pyx_t_10;

    /* "fast_smatch/_smatch.pyx":70
 *     # if no concept match, generate a random mapping
 *     for i in no_word_match:
 *         candidates = [m for m in candidate_mapping.at(i) if matched_dict.count(m) == 0]             # <<<<<<<<<<<<<<
 *         if len(candidates) > 0:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    try {
      __pyx_t_12 = __pyx_v_candidate_mapping.at(__pyx_v_i);
    } catch(...) {
      __Pyx_CppExn2PyErr();
    ...
    for (;;) {
      ...
      __pyx_t_8 = ((__pyx_v_matched_dict.count(__pyx_v_m) == 0) != 0);
      if (__pyx_t_8) {
 ...
 */
      ...
      if (!__pyx_t_2) {
        ...
        #endif
        {
          __pyx_t_15 = PyTuple_New(1+1); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 72, __pyx_L1_error)
          ...
          PyTuple_SET_ITEM(__pyx_t_15, 0+1, __pyx_v_candidates);
          __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_15, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 72, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
        }
      }
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_10 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      (__pyx_v_result[__pyx_v_i]) = __pyx_t_10;

      /* "fast_smatch/_smatch.pyx":73
 *         if len(candidates) > 0:
 *             result[i] = random.choice(candidates)
 *             matched_dict.insert(result[i])             # <<<<<<<<<<<<<<
 * 
 * 
 */
      __pyx_v_matched_dict.insert((__pyx_v_result[__pyx_v_i]));
 ...
 */
  ...
  __Pyx_WriteUnraisable("fast_smatch._smatch.smart_init_mapping", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
...
static void __pyx_f_11fast_smatch_7_smatch_random_init_mapping(std::vector<std::unordered_set<int> >  const &__pyx_v_candidate_mapping, std::vector<int>  &__pyx_v_result) {
  std::unordered_set<int>  __pyx_v_matched_dict;
  Py_ssize_t __pyx_v_i;
  PyObject *__pyx_v_candidates = NULL;
  ...
  Py_ssize_t __pyx_t_5;
  __Pyx_FakeReference<std::unordered_set<int> > __pyx_t_6;
  std::unordered_set<int> ::iterator __pyx_t_7;
 ...
 */
    ...
    for (;;) {
      ...
      ++__pyx_t_7;
      __pyx_v_m = __pyx_t_9;
      __pyx_t_10 = ((__pyx_v_matched_dict.count(__pyx_v_m) == 0) != 0);
      if (__pyx_t_10) {
 ...
 *             result.push_back(-1)
 */
    __pyx_t_11 = PyList_GET_SIZE(__pyx_v_candidates); if (unlikely(__pyx_t_11 == ((Py_ssize_t)-1))) __PYX_ERR(0, 94, __pyx_L1_error)
    __pyx_t_10 = ((__pyx_t_11 == 0) != 0);
    if (__pyx_t_10) {

      /* "fast_smatch/_smatch.pyx":96
 *         if len(candidates) == 0:
 *             # -1 indicates no possible mapping
 *             result.push_back(-1)             # <<<<<<<<<<<<<<
 *         else:
    ...
    /*else*/ {
      ...
      if (!__pyx_t_3) {
        ...
        #endif
        {
          ...
          __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_12, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 98, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
      __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_v_rid); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 99, __pyx_L1_error)
      try {
        __pyx_v_result.push_back(__pyx_t_9);
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 99, __pyx_L1_error)
      }

      /* "fast_smatch/_smatch.pyx":100
 *             rid = random.choice(candidates)
 *             result.push_back(rid)
 *             matched_dict.insert(rid)             # <<<<<<<<<<<<<<
 * 
 * 
 */
      __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_v_rid); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 100, __pyx_L1_error)
      __pyx_v_matched_dict.insert(__pyx_t_9);
    }
    __pyx_L8:;
  }
 ...
 */
  ...
  __Pyx_WriteUnraisable("fast_smatch._smatch.random_init_mapping", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_candidates);
...
static void __pyx_f_11fast_smatch_7_smatch_compute_pool(PyObject *__pyx_v_instance1, PyObject *__pyx_v_attribute1, PyObject *__pyx_v_relation1, PyObject *__pyx_v_instance2, PyObject *__pyx_v_attribute2, PyObject *__pyx_v_relation2, PyObject *__pyx_v_prefix1, PyObject *__pyx_v_prefix2, std::vector<std::unordered_set<int> >  &__pyx_v_candidate_mapping, std::unordered_map<int,std::unordered_map<int,int> >  &__pyx_v_weight_dict) {
  ...
  PyObject *__pyx_v_node1_index_sig1 = NULL;
  PyObject *__pyx_v_node1_index_sig2 = NULL;
  PyObject *__pyx_v_node2_index_sig1 = NULL;
  PyObject *__pyx_v_node2_index_sig2 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  std::vector<std::unordered_set<int> > ::size_type __pyx_t_13;
  int __pyx_t_14;
  int __pyx_t_15;
  __Pyx_RefNannySetupContext("compute_pool", 0);

  /* "fast_smatch/_smatch.pyx":135
 * 
 *     """
 ...
 */
    ...
    try {
      __pyx_v_candidate_mapping.push_back(__pyx_t_3);
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 143, __pyx_L1_error)
    }

    /* "fast_smatch/_smatch.pyx":144
 *         # each candidate mapping is a set of node indices
 *         candidate_mapping.push_back(unordered_set[int]())
 *         for j in range(len(instance2)):             # <<<<<<<<<<<<<<
 *             # if both triples are instance triples and have the same valueprint(G.edges(data=True))
 ...
 */
    __pyx_t_4 = PyObject_Length(__pyx_v_instance2); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 144, __pyx_L1_error)
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      __pyx_v_j = __pyx_t_5;

      /* "fast_smatch/_smatch.pyx":146
 *         for j in range(len(instance2)):
 *             # if both triples are instance triples and have the same valueprint(G.edges(data=True))
 *             if instance1[i][0].lower() == instance2[j][0].lower() \             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_instance1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_t_8, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_lower); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      ...
      if (__pyx_t_9) {
        __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 146, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      } else {
        __pyx_t_7 = __Pyx_PyObject_CallNoArg(__pyx_t_8); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 146, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_v_instance2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_t_9, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_lower); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      ...
      if (__pyx_t_10) {
        __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_t_10); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 146, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      } else {
        __pyx_t_8 = __Pyx_PyObject_CallNoArg(__pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 146, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = PyObject_RichCompare(__pyx_t_7, __pyx_t_8, Py_EQ); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_11 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_11 < 0)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      if (__pyx_t_11) {
      } else {
 ...
 */
      __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_instance1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_8, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_lower); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
      ...
      if (__pyx_t_7) {
        __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 147, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      } else {
        __pyx_t_9 = __Pyx_PyObject_CallNoArg(__pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 147, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_instance2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_t_7, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_lower); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = NULL;
      ...
      if (__pyx_t_10) {
        __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_10); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 147, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      } else {
        __pyx_t_8 = __Pyx_PyObject_CallNoArg(__pyx_t_7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 147, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = PyObject_RichCompare(__pyx_t_9, __pyx_t_8, Py_EQ); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
        __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_instance1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_t_7, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix1); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 149, __pyx_L1_error)
        __pyx_t_7 = __Pyx_PyObject_GetSlice(__pyx_t_8, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = __Pyx_PyNumber_Int(__pyx_t_7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node1_index, __pyx_t_8);
        __pyx_t_8 = 0;

        /* "fast_smatch/_smatch.pyx":150
 *                 # get node index by stripping the prefix
 *                 node1_index = int(instance1[i][1][len(prefix1):])
 *                 node2_index = int(instance2[j][1][len(prefix2):])             # <<<<<<<<<<<<<<
 *                 candidate_mapping[node1_index].insert(node2_index)
 ...
 */
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_instance2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_8, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix2); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 150, __pyx_L1_error)
        __pyx_t_8 = __Pyx_PyObject_GetSlice(__pyx_t_7, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_7 = __Pyx_PyNumber_Int(__pyx_t_8); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node2_index, __pyx_t_7);
        __pyx_t_7 = 0;

        /* "fast_smatch/_smatch.pyx":151
 *                 node1_index = int(instance1[i][1][len(prefix1):])
 *                 node2_index = int(instance2[j][1][len(prefix2):])
 *                 candidate_mapping[node1_index].insert(node2_index)             # <<<<<<<<<<<<<<
 *                 node_pair = _hash_pair(node1_index, node2_index)
 ...
 */
        __pyx_t_13 = __Pyx_PyInt_As_size_t(__pyx_v_node1_index); if (unlikely((__pyx_t_13 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 151, __pyx_L1_error)
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node2_index); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 151, __pyx_L1_error)
        (__pyx_v_candidate_mapping[__pyx_t_13]).insert(__pyx_t_14);

        /* "fast_smatch/_smatch.pyx":152
 *                 node2_index = int(instance2[j][1][len(prefix2):])
 *                 candidate_mapping[node1_index].insert(node2_index)
 *                 node_pair = _hash_pair(node1_index, node2_index)             # <<<<<<<<<<<<<<
 *                 weight_dict[node_pair][-1] += 1
 ...
 */
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node1_index); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 152, __pyx_L1_error)
        __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node2_index); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 152, __pyx_L1_error)
        __pyx_v_node_pair = _hash_pair(__pyx_t_14, __pyx_t_15);

        /* "fast_smatch/_smatch.pyx":153
 *                 candidate_mapping[node1_index].insert(node2_index)
 *                 node_pair = _hash_pair(node1_index, node2_index)
 *                 weight_dict[node_pair][-1] += 1             # <<<<<<<<<<<<<<
 *     for i in range(0, len(attribute1)):
 ...
 */
        __pyx_t_15 = __pyx_v_node_pair;
        __pyx_t_14 = -1;
        ((__pyx_v_weight_dict[__pyx_t_15])[__pyx_t_14]) = (((__pyx_v_weight_dict[__pyx_t_15])[__pyx_t_14]) + 1);
 ...
 */
    __pyx_t_4 = PyObject_Length(__pyx_v_attribute2); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 155, __pyx_L1_error)
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      __pyx_v_j = __pyx_t_5;

      /* "fast_smatch/_smatch.pyx":157
 *         for j in range(0, len(attribute2)):
 *             # if both attribute relation triple have the same relation name and value
 *             if attribute1[i][0].lower() == attribute2[j][0].lower() \             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_attribute1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_t_8, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_lower); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
      ...
      if (__pyx_t_9) {
        __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 157, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      } else {
        __pyx_t_7 = __Pyx_PyObject_CallNoArg(__pyx_t_8); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 157, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_v_attribute2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_t_9, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_lower); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_9))) {
      ...
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = PyObject_RichCompare(__pyx_t_7, __pyx_t_8, Py_EQ); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_11 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_11 < 0)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      if (__pyx_t_11) {
      } else {
        __pyx_t_6 = __pyx_t_11;
 ...
 */
      __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_attribute1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_8, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_lower); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
      ...
      if (__pyx_t_7) {
        __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 158, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      } else {
        __pyx_t_9 = __Pyx_PyObject_CallNoArg(__pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 158, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_attribute2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_t_7, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_lower); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_7))) {
      ...
      if (__pyx_t_10) {
        __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_10); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 158, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      } else {
        __pyx_t_8 = __Pyx_PyObject_CallNoArg(__pyx_t_7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 158, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = PyObject_RichCompare(__pyx_t_9, __pyx_t_8, Py_EQ); __Pyx_XGOTREF(__pyx_t_7); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 158, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 *                 candidate_mapping[node1_index].insert(node2_index)
 */
        __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_attribute1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 159, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_t_7, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 159, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix1); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 159, __pyx_L1_error)
        __pyx_t_7 = __Pyx_PyObject_GetSlice(__pyx_t_8, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 159, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = __Pyx_PyNumber_Int(__pyx_t_7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 159, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node1_index, __pyx_t_8);
        __pyx_t_8 = 0;

        /* "fast_smatch/_smatch.pyx":160
 *                     and attribute1[i][2].lower() == attribute2[j][2].lower():
 *                 node1_index = int(attribute1[i][1][len(prefix1):])
 *                 node2_index = int(attribute2[j][1][len(prefix2):])             # <<<<<<<<<<<<<<
 *                 candidate_mapping[node1_index].insert(node2_index)
 *                 node_pair = _hash_pair(node1_index, node2_index)
 */
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_attribute2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 160, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_8, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 160, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix2); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 160, __pyx_L1_error)
        __pyx_t_8 = __Pyx_PyObject_GetSlice(__pyx_t_7, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 160, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_7 = __Pyx_PyNumber_Int(__pyx_t_8); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 160, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node2_index, __pyx_t_7);
        __pyx_t_7 = 0;

        /* "fast_smatch/_smatch.pyx":161
 *                 node1_index = int(attribute1[i][1][len(prefix1):])
 *                 node2_index = int(attribute2[j][1][len(prefix2):])
 *                 candidate_mapping[node1_index].insert(node2_index)             # <<<<<<<<<<<<<<
 *                 node_pair = _hash_pair(node1_index, node2_index)
 *                 weight_dict[node_pair][-1] += 1
 */
        __pyx_t_13 = __Pyx_PyInt_As_size_t(__pyx_v_node1_index); if (unlikely((__pyx_t_13 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 161, __pyx_L1_error)
        __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node2_index); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 161, __pyx_L1_error)
        (__pyx_v_candidate_mapping[__pyx_t_13]).insert(__pyx_t_15);

        /* "fast_smatch/_smatch.pyx":162
 *                 node2_index = int(attribute2[j][1][len(prefix2):])
 *                 candidate_mapping[node1_index].insert(node2_index)
 *                 node_pair = _hash_pair(node1_index, node2_index)             # <<<<<<<<<<<<<<
 *                 weight_dict[node_pair][-1] += 1
 ...
 */
        __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node1_index); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 162, __pyx_L1_error)
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node2_index); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 162, __pyx_L1_error)
        __pyx_v_node_pair = _hash_pair(__pyx_t_15, __pyx_t_14);

        /* "fast_smatch/_smatch.pyx":163
 *                 candidate_mapping[node1_index].insert(node2_index)
 *                 node_pair = _hash_pair(node1_index, node2_index)
 *                 weight_dict[node_pair][-1] += 1             # <<<<<<<<<<<<<<
 *     for i in range(0, len(relation1)):
 ...
 */
        __pyx_t_14 = __pyx_v_node_pair;
        __pyx_t_15 = -1;
        ((__pyx_v_weight_dict[__pyx_t_14])[__pyx_t_15]) = (((__pyx_v_weight_dict[__pyx_t_14])[__pyx_t_15]) + 1);
 ...
 */
    __pyx_t_4 = PyObject_Length(__pyx_v_relation2); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 165, __pyx_L1_error)
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      __pyx_v_j = __pyx_t_5;

      /* "fast_smatch/_smatch.pyx":167
 *         for j in range(0, len(relation2)):
 *             # if both relation share the same name
 *             if relation1[i][0].lower() == relation2[j][0].lower():             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_relation1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_t_8, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_lower); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
      ...
      if (__pyx_t_9) {
        __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 167, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      } else {
        __pyx_t_7 = __Pyx_PyObject_CallNoArg(__pyx_t_8); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 167, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_v_relation2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_t_9, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_lower); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = NULL;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_9))) {
      ...
      if (__pyx_t_10) {
        __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_t_10); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 167, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      } else {
        __pyx_t_8 = __Pyx_PyObject_CallNoArg(__pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 167, __pyx_L1_error)
      }
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = PyObject_RichCompare(__pyx_t_7, __pyx_t_8, Py_EQ); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 167, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      if (__pyx_t_6) {

        /* "fast_smatch/_smatch.pyx":168
 *             # if both relation share the same name
 *             if relation1[i][0].lower() == relation2[j][0].lower():
 *                 node1_index_sig1 = int(relation1[i][1][len(prefix1):])             # <<<<<<<<<<<<<<
 *                 node1_index_sig2 = int(relation2[j][1][len(prefix2):])
 ...
 */
        __pyx_t_9 = __Pyx_GetItemInt(__pyx_v_relation1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 168, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_t_9, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 168, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix1); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 168, __pyx_L1_error)
        __pyx_t_9 = __Pyx_PyObject_GetSlice(__pyx_t_8, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 168, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = __Pyx_PyNumber_Int(__pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 168, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node1_index_sig1, __pyx_t_8);
        __pyx_t_8 = 0;

        /* "fast_smatch/_smatch.pyx":169
 *             if relation1[i][0].lower() == relation2[j][0].lower():
 *                 node1_index_sig1 = int(relation1[i][1][len(prefix1):])
 *                 node1_index_sig2 = int(relation2[j][1][len(prefix2):])             # <<<<<<<<<<<<<<
 *                 node2_index_sig1 = int(relation1[i][2][len(prefix1):])
 ...
 */
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_relation2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 169, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_9 = __Pyx_GetItemInt(__pyx_t_8, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 169, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix2); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 169, __pyx_L1_error)
        __pyx_t_8 = __Pyx_PyObject_GetSlice(__pyx_t_9, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 169, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_t_9 = __Pyx_PyNumber_Int(__pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 169, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node1_index_sig2, __pyx_t_9);
        __pyx_t_9 = 0;

        /* "fast_smatch/_smatch.pyx":170
 *                 node1_index_sig1 = int(relation1[i][1][len(prefix1):])
 *                 node1_index_sig2 = int(relation2[j][1][len(prefix2):])
 *                 node2_index_sig1 = int(relation1[i][2][len(prefix1):])             # <<<<<<<<<<<<<<
 *                 node2_index_sig2 = int(relation2[j][2][len(prefix2):])
 ...
 */
        __pyx_t_9 = __Pyx_GetItemInt(__pyx_v_relation1, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 170, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_t_9, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 170, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix1); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 170, __pyx_L1_error)
        __pyx_t_9 = __Pyx_PyObject_GetSlice(__pyx_t_8, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 170, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = __Pyx_PyNumber_Int(__pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 170, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node2_index_sig1, __pyx_t_8);
        __pyx_t_8 = 0;

        /* "fast_smatch/_smatch.pyx":171
 *                 node1_index_sig2 = int(relation2[j][1][len(prefix2):])
 *                 node2_index_sig1 = int(relation1[i][2][len(prefix1):])
 *                 node2_index_sig2 = int(relation2[j][2][len(prefix2):])             # <<<<<<<<<<<<<<
 *                 # add mapping between two nodes
 ...
 */
        __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_relation2, __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 171, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_9 = __Pyx_GetItemInt(__pyx_t_8, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 171, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_12 = PyObject_Length(__pyx_v_prefix2); if (unlikely(__pyx_t_12 == ((Py_ssize_t)-1))) __PYX_ERR(0, 171, __pyx_L1_error)
        __pyx_t_8 = __Pyx_PyObject_GetSlice(__pyx_t_9, __pyx_t_12, 0, NULL, NULL, NULL, 1, 0, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 171, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_t_9 = __Pyx_PyNumber_Int(__pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 171, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_XDECREF_SET(__pyx_v_node2_index_sig2, __pyx_t_9);
        __pyx_t_9 = 0;

        /* "fast_smatch/_smatch.pyx":173
 *                 node2_index_sig2 = int(relation2[j][2][len(prefix2):])
 *                 # add mapping between two nodes
 *                 candidate_mapping[node1_index_sig1].insert(node1_index_sig2)             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_t_13 = __Pyx_PyInt_As_size_t(__pyx_v_node1_index_sig1); if (unlikely((__pyx_t_13 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 173, __pyx_L1_error)
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node1_index_sig2); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 173, __pyx_L1_error)
        (__pyx_v_candidate_mapping[__pyx_t_13]).insert(__pyx_t_14);

        /* "fast_smatch/_smatch.pyx":174
 *                 # add mapping between two nodes
 *                 candidate_mapping[node1_index_sig1].insert(node1_index_sig2)
 *                 candidate_mapping[node2_index_sig1].insert(node2_index_sig2)             # <<<<<<<<<<<<<<
 *                 node_pair1 = _hash_pair(node1_index_sig1, node1_index_sig2)
 ...
 */
        __pyx_t_13 = __Pyx_PyInt_As_size_t(__pyx_v_node2_index_sig1); if (unlikely((__pyx_t_13 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 174, __pyx_L1_error)
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node2_index_sig2); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 174, __pyx_L1_error)
        (__pyx_v_candidate_mapping[__pyx_t_13]).insert(__pyx_t_14);

        /* "fast_smatch/_smatch.pyx":175
 *                 candidate_mapping[node1_index_sig1].insert(node1_index_sig2)
 *                 candidate_mapping[node2_index_sig1].insert(node2_index_sig2)
 *                 node_pair1 = _hash_pair(node1_index_sig1, node1_index_sig2)             # <<<<<<<<<<<<<<
 *                 node_pair2 = _hash_pair(node2_index_sig1, node2_index_sig2)
 ...
 */
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node1_index_sig1); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 175, __pyx_L1_error)
        __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node1_index_sig2); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 175, __pyx_L1_error)
        __pyx_v_node_pair1 = _hash_pair(__pyx_t_14, __pyx_t_15);

        /* "fast_smatch/_smatch.pyx":176
 *                 candidate_mapping[node2_index_sig1].insert(node2_index_sig2)
 *                 node_pair1 = _hash_pair(node1_index_sig1, node1_index_sig2)
 *                 node_pair2 = _hash_pair(node2_index_sig1, node2_index_sig2)             # <<<<<<<<<<<<<<
 *                 if node_pair2 != node_pair1:
 ...
 */
        __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node2_index_sig1); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L1_error)
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node2_index_sig2); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L1_error)
        __pyx_v_node_pair2 = _hash_pair(__pyx_t_15, __pyx_t_14);

        /* "fast_smatch/_smatch.pyx":177
 *                 node_pair1 = _hash_pair(node1_index_sig1, node1_index_sig2)
 *                 node_pair2 = _hash_pair(node2_index_sig1, node2_index_sig2)
 *                 if node_pair2 != node_pair1:             # <<<<<<<<<<<<<<
 *                     # update weight_dict weight. Note that we need to update both entries for future search
 ...
 */
        __pyx_t_6 = ((__pyx_v_node_pair2 != __pyx_v_node_pair1) != 0);
        if (__pyx_t_6) {

          /* "fast_smatch/_smatch.pyx":181
 *                     # i.e weight_dict[node_pair1][node_pair2]
 ...
 */
          __pyx_t_9 = PyObject_RichCompare(__pyx_v_node1_index_sig1, __pyx_v_node2_index_sig1, Py_GT); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 181, __pyx_L1_error)
          __pyx_t_6 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 181, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
          if (__pyx_t_6) {

            /* "fast_smatch/_smatch.pyx":183
 *                     if node1_index_sig1 > node2_index_sig1:
 *                         # swap node_pair1 and node_pair2
 *                         node_pair1 = _hash_pair(node2_index_sig1, node2_index_sig2)             # <<<<<<<<<<<<<<
 ...
 */
            __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node2_index_sig1); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 183, __pyx_L1_error)
            __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node2_index_sig2); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 183, __pyx_L1_error)
            __pyx_v_node_pair1 = _hash_pair(__pyx_t_14, __pyx_t_15);

            /* "fast_smatch/_smatch.pyx":184
 *                         # swap node_pair1 and node_pair2
 *                         node_pair1 = _hash_pair(node2_index_sig1, node2_index_sig2)
 *                         node_pair2 = _hash_pair(node1_index_sig1, node1_index_sig2)             # <<<<<<<<<<<<<<
 *                     if weight_dict.count(node_pair1):
 ...
 */
            __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_node1_index_sig1); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 184, __pyx_L1_error)
            __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_node1_index_sig2); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 184, __pyx_L1_error)
            __pyx_v_node_pair2 = _hash_pair(__pyx_t_15, __pyx_t_14);
 ...
 *                     else:
 */
          __pyx_t_6 = (__pyx_v_weight_dict.count(__pyx_v_node_pair1) != 0);
          if (__pyx_t_6) {

            /* "fast_smatch/_smatch.pyx":186
 *                         node_pair2 = _hash_pair(node1_index_sig1, node1_index_sig2)
 *                     if weight_dict.count(node_pair1):
 *                         weight_dict[node_pair1][node_pair2] += 1             # <<<<<<<<<<<<<<
 *                     else:
 ...
 */
            __pyx_t_14 = __pyx_v_node_pair1;
            __pyx_t_15 = __pyx_v_node_pair2;
            ((__pyx_v_weight_dict[__pyx_t_14])[__pyx_t_15]) = (((__pyx_v_weight_dict[__pyx_t_14])[__pyx_t_15]) + 1);
 ...
 *                     else:
 */
          __pyx_t_6 = (__pyx_v_weight_dict.count(__pyx_v_node_pair2) != 0);
          if (__pyx_t_6) {

            /* "fast_smatch/_smatch.pyx":191
 *                         weight_dict[node_pair1][node_pair2] = 1
 *                     if weight_dict.count(node_pair2):
 *                         weight_dict[node_pair2][node_pair1] += 1             # <<<<<<<<<<<<<<
 *                     else:
 ...
 */
            __pyx_t_14 = __pyx_v_node_pair2;
            __pyx_t_15 = __pyx_v_node_pair1;
            ((__pyx_v_weight_dict[__pyx_t_14])[__pyx_t_15]) = (((__pyx_v_weight_dict[__pyx_t_14])[__pyx_t_15]) + 1);
 ...
 */
  ...
  __Pyx_WriteUnraisable("fast_smatch._smatch.compute_pool", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_node1_index);
  __Pyx_XDECREF(__pyx_v_node2_index);
  __Pyx_XDECREF(__pyx_v_node1_index_sig1);
  __Pyx_XDECREF(__pyx_v_node1_index_sig2);
  __Pyx_XDECREF(__pyx_v_node2_index_sig1);
  __Pyx_XDECREF(__pyx_v_node2_index_sig2);
  __Pyx_RefNannyFinishContext();
}
...
static int __pyx_f_11fast_smatch_7_smatch_compute_match(std::vector<int>  const &__pyx_v_mapping, std::unordered_map<int,std::unordered_map<int,int> >  &__pyx_v_weight_dict, struct __pyx_opt_args_11fast_smatch_7_smatch_compute_match *__pyx_optional_args) {

  /* "fast_smatch/_smatch.pyx":204
 * cdef int compute_match(const vector[int] & mapping,
 *                        unordered_map[int, unordered_map[int, int]] & weight_dict,
 *                        verbose=False):             # <<<<<<<<<<<<<<
 *     """
 ...
 */
  ...
  __Pyx_WriteUnraisable("fast_smatch._smatch.compute_match", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __pyx_f_11fast_smatch_7_smatch_get_best_gain(std::vector<int>  &__pyx_v_mapping, std::vector<std::unordered_set<int> >  &__pyx_v_candidate_mappings, std::unordered_map<int,std::unordered_map<int,int> >  &__pyx_v_weight_dict, int __pyx_v_instance_len, int __pyx_v_cur_match_num, std::vector<int>  &__pyx_v_cur_mapping, struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_gain *__pyx_optional_args) {

  /* "fast_smatch/_smatch.pyx":258
 *                        int instance_len,
 *                        int cur_match_num,
 ...
 */
  ...
  std::vector<std::unordered_set<int> > ::size_type __pyx_t_12;
 ...
 */
    __pyx_t_5 = (__Pyx_PySequence_ContainsTF(__pyx_v_nid, __pyx_v_unmatched, Py_EQ)); if (unlikely(__pyx_t_5 < 0)) __PYX_ERR(0, 287, __pyx_L1_error)
    __pyx_t_6 = (__pyx_t_5 != 0);
    if (__pyx_t_6) {

      /* "fast_smatch/_smatch.pyx":288
 *     for nid in mapping:
 *         if nid in unmatched:
 *             unmatched.remove(nid)             # <<<<<<<<<<<<<<
 *     for i, nid in enumerate(mapping):
 ...
 */
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_unmatched, __pyx_n_s_remove); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 288, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_7 = NULL;
      ...
      if (!__pyx_t_7) {
        __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_v_nid); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 288, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
      } else {
        #if CYTHON_FAST_PYCALL
        if (PyFunction_Check(__pyx_t_1)) {
          PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_v_nid};
          __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 288, __pyx_L1_error)
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
          PyObject *__pyx_temp[2] = {__pyx_t_7, __pyx_v_nid};
          __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 288, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_7); __pyx_t_7 = 0;
          __Pyx_GOTREF(__pyx_t_2);
        } else
        #endif
        {
          ...
          PyTuple_SET_ITEM(__pyx_t_8, 0+1, __pyx_v_nid);
 ...
 */
    __pyx_t_1 = PyObject_GetIter(__pyx_v_unmatched); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 291, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_11 = Py_TYPE(__pyx_t_1)->tp_iternext; if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 291, __pyx_L1_error)
    for (;;) {
      {
 ...
 *                 # (i, m) -> (i, nm)
 */
      __pyx_t_12 = __Pyx_PyInt_As_size_t(__pyx_v_i); if (unlikely((__pyx_t_12 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 292, __pyx_L1_error)
      __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_nm); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 292, __pyx_L1_error)
      __pyx_t_6 = ((__pyx_v_candidate_mappings[__pyx_t_12]).count(__pyx_t_4) != 0);
      if (__pyx_t_6) {

        /* "fast_smatch/_smatch.pyx":295
 *                 # remap i to another unmatched node (move)
 *                 # (i, m) -> (i, nm)
 *                 if verbose:             # <<<<<<<<<<<<<<
 ...
 *                 if verbose:
 */
          __pyx_t_7 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 296, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          ...
          PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_kp_s_Remap_node);
          __Pyx_INCREF(__pyx_v_i);
          __Pyx_GIVEREF(__pyx_v_i);
          PyTuple_SET_ITEM(__pyx_t_13, 1, __pyx_v_i);
          __Pyx_INCREF(__pyx_kp_s_from);
          __Pyx_GIVEREF(__pyx_kp_s_from);
          PyTuple_SET_ITEM(__pyx_t_13, 2, __pyx_kp_s_from);
          __Pyx_INCREF(__pyx_v_nid);
          __Pyx_GIVEREF(__pyx_v_nid);
          PyTuple_SET_ITEM(__pyx_t_13, 3, __pyx_v_nid);
          __Pyx_INCREF(__pyx_n_s_to);
          __Pyx_GIVEREF(__pyx_n_s_to);
          PyTuple_SET_ITEM(__pyx_t_13, 4, __pyx_n_s_to);
          __Pyx_INCREF(__pyx_v_nm);
          __Pyx_GIVEREF(__pyx_v_nm);
          PyTuple_SET_ITEM(__pyx_t_13, 5, __pyx_v_nm);
          if (__Pyx_Print(__pyx_t_7, __pyx_t_13, 1) < 0) __PYX_ERR(0, 296, __pyx_L1_error)
 ...
 */
        __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_i); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 297, __pyx_L1_error)
        __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_nid); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 297, __pyx_L1_error)
        __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_nm); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 297, __pyx_L1_error)
        __pyx_v_mv_gain = move_gain(__pyx_v_mapping, __pyx_t_4, __pyx_t_14, __pyx_t_15, __pyx_v_weight_dict, __pyx_v_cur_match_num);

        /* "fast_smatch/_smatch.pyx":298
 *                     print >> DEBUG_LOG, "Remap node", i, "from ", nid, "to", nm
 *                 mv_gain = move_gain(mapping, i, nid, nm, weight_dict, cur_match_num)
 *                 if verbose:             # <<<<<<<<<<<<<<
 *                     print >> DEBUG_LOG, "Move gain:", mv_gain
 ...
 *                     new_mapping[i] = nm
 */
          __pyx_t_7 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 299, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_mv_gain); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 299, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_13);
          ...
          PyTuple_SET_ITEM(__pyx_t_16, 0, __pyx_kp_s_Move_gain);
          __Pyx_GIVEREF(__pyx_t_13);
          PyTuple_SET_ITEM(__pyx_t_16, 1, __pyx_t_13);
          __pyx_t_13 = 0;
          if (__Pyx_Print(__pyx_t_7, __pyx_t_16, 1) < 0) __PYX_ERR(0, 299, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;

          /* "fast_smatch/_smatch.pyx":300
 *                 if verbose:
 *                     print >> DEBUG_LOG, "Move gain:", mv_gain
 *                     new_mapping = mapping[:]             # <<<<<<<<<<<<<<
 *                     new_mapping[i] = nm
 ...
 */
          __pyx_t_7 = __pyx_convert_vector_to_py_int(__pyx_v_mapping); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 300, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          __pyx_t_16 = __Pyx_PyObject_GetSlice(__pyx_t_7, 0, 0, NULL, NULL, &__pyx_slice_, 0, 0, 1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 300, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_16);
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
          if (!(likely(PyBytes_CheckExact(__pyx_t_16))||((__pyx_t_16) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_16)->tp_name), 0))) __PYX_ERR(0, 300, __pyx_L1_error)
          __Pyx_XDECREF_SET(__pyx_v_new_mapping, ((PyObject*)__pyx_t_16));
          __pyx_t_16 = 0;

          /* "fast_smatch/_smatch.pyx":301
 *                     print >> DEBUG_LOG, "Move gain:", mv_gain
 *                     new_mapping = mapping[:]
 *                     new_mapping[i] = nm             # <<<<<<<<<<<<<<
 *                     new_match_num = compute_match(new_mapping, weight_dict)
 ...
 */
          __pyx_t_17 = __pyx_convert_vector_from_py_int(__pyx_v_new_mapping); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 302, __pyx_L1_error)
          __pyx_v_new_match_num = __pyx_f_11fast_smatch_7_smatch_compute_match(__pyx_t_17, __pyx_v_weight_dict, NULL);

          /* "fast_smatch/_smatch.pyx":303
 *                     new_mapping[i] = nm
 *                     new_match_num = compute_match(new_mapping, weight_dict)
 *                     if new_match_num != cur_match_num + mv_gain:             # <<<<<<<<<<<<<<
 *                         print >> ERROR_LOG, mapping, new_mapping
 ...
 *                             new_match_num
 */
            __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_ERROR_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 304, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_16);
            __pyx_t_7 = __pyx_convert_vector_to_py_int(__pyx_v_mapping); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 304, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_7);
            __pyx_t_13 = PyTuple_New(2); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 304, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_13);
            __Pyx_GIVEREF(__pyx_t_7);
            PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_t_7);
            __Pyx_INCREF(__pyx_v_new_mapping);
            __Pyx_GIVEREF(__pyx_v_new_mapping);
            PyTuple_SET_ITEM(__pyx_t_13, 1, __pyx_v_new_mapping);
            __pyx_t_7 = 0;
            if (__Pyx_Print(__pyx_t_16, __pyx_t_13, 1) < 0) __PYX_ERR(0, 304, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
            __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;

            /* "fast_smatch/_smatch.pyx":305
 *                     if new_match_num != cur_match_num + mv_gain:
 *                         print >> ERROR_LOG, mapping, new_mapping
 *                         print >> ERROR_LOG, "Inconsistency in computing: move gain", cur_match_num, mv_gain, \             # <<<<<<<<<<<<<<
 *                             new_match_num
 ...
 */
            __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_ERROR_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 305, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_16);
            __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_cur_match_num); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 305, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_13);
            __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_mv_gain); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 305, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_7);

            /* "fast_smatch/_smatch.pyx":306
 *                         print >> ERROR_LOG, mapping, new_mapping
 *                         print >> ERROR_LOG, "Inconsistency in computing: move gain", cur_match_num, mv_gain, \
 *                             new_match_num             # <<<<<<<<<<<<<<
 *                 if mv_gain > largest_gain:
 ...
 */
            __pyx_t_18 = __Pyx_PyInt_From_int(__pyx_v_new_match_num); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 306, __pyx_L1_error)
 ...
 *                 if mv_gain > largest_gain:
 */
            __pyx_t_19 = PyTuple_New(4); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 305, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_19);
            __Pyx_INCREF(__pyx_kp_s_Inconsistency_in_computing_move);
            __Pyx_GIVEREF(__pyx_kp_s_Inconsistency_in_computing_move);
            PyTuple_SET_ITEM(__pyx_t_19, 0, __pyx_kp_s_Inconsistency_in_computing_move);
            __Pyx_GIVEREF(__pyx_t_13);
            ...
            __pyx_t_7 = 0;
            __pyx_t_18 = 0;
            if (__Pyx_Print(__pyx_t_16, __pyx_t_19, 1) < 0) __PYX_ERR(0, 305, __pyx_L1_error)
 ...
 *                     use_swap = 0
 */
          __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_i); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 309, __pyx_L1_error)
          __pyx_v_node1 = __pyx_t_15;

          /* "fast_smatch/_smatch.pyx":310
 *                     largest_gain = mv_gain
 *                     node1 = i
 *                     node2 = nm             # <<<<<<<<<<<<<<
 *                     use_swap = 0
 *     # compute swap gain
 */
          __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_nm); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 310, __pyx_L1_error)
          __pyx_v_node2 = __pyx_t_15;

          /* "fast_smatch/_smatch.pyx":311
 *                     node1 = i
 *                     node2 = nm
 *                     use_swap = 0             # <<<<<<<<<<<<<<
 *     # compute swap gain
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_16 = __pyx_convert_vector_to_py_int(__pyx_v_mapping); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 314, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_20 = PyObject_Length(__pyx_t_16); if (unlikely(__pyx_t_20 == ((Py_ssize_t)-1))) __PYX_ERR(0, 314, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    __pyx_t_16 = PyInt_FromSsize_t(__pyx_t_20); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 314, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_19 = PyTuple_New(2); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 314, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    ...
    __pyx_t_8 = 0;
    __pyx_t_16 = 0;
    __pyx_t_16 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_19, NULL); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 314, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
    if (likely(PyList_CheckExact(__pyx_t_16)) || PyTuple_CheckExact(__pyx_t_16)) {
      __pyx_t_19 = __pyx_t_16; __Pyx_INCREF(__pyx_t_19); __pyx_t_20 = 0;
      __pyx_t_11 = NULL;
    } else {
      __pyx_t_20 = -1; __pyx_t_19 = PyObject_GetIter(__pyx_t_16); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 314, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_19);
      __pyx_t_11 = Py_TYPE(__pyx_t_19)->tp_iternext; if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 314, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    for (;;) {
      if (likely(!__pyx_t_11)) {
        if (likely(PyList_CheckExact(__pyx_t_19))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_16 = PyList_GET_ITEM(__pyx_t_19, __pyx_t_20); __Pyx_INCREF(__pyx_t_16); __pyx_t_20++; if (unlikely(0 < 0)) __PYX_ERR(0, 314, __pyx_L1_error)
          #else
          __pyx_t_16 = PySequence_ITEM(__pyx_t_19, __pyx_t_20); __pyx_t_20++; if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 314, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_16);
          #endif
        } else {
          if (__pyx_t_20 >= PyTuple_GET_SIZE(__pyx_t_19)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_16 = PyTuple_GET_ITEM(__pyx_t_19, __pyx_t_20); __Pyx_INCREF(__pyx_t_16); __pyx_t_20++; if (unlikely(0 < 0)) __PYX_ERR(0, 314, __pyx_L1_error)
          #else
          __pyx_t_16 = PySequence_ITEM(__pyx_t_19, __pyx_t_20); __pyx_t_20++; if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 314, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_16);
          #endif
        ...
        __pyx_t_16 = __pyx_t_11(__pyx_t_19);
 ...
 */
      __pyx_t_21 = __Pyx_PyInt_As_size_t(__pyx_v_j); if (unlikely((__pyx_t_21 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 315, __pyx_L1_error)
      __pyx_v_m2 = (__pyx_v_mapping[__pyx_t_21]);

      /* "fast_smatch/_smatch.pyx":318
 *             # swap operation (i, m) (j, m2) -> (i, m2) (j, m)
 *             # j starts from i+1, to avoid duplicate swap
 *             if verbose:             # <<<<<<<<<<<<<<
 ...
 *                 print >> DEBUG_LOG, mapping
 */
        __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 319, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        ...
        if (__Pyx_Print(__pyx_t_16, __pyx_t_8, 1) < 0) __PYX_ERR(0, 319, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;

        /* "fast_smatch/_smatch.pyx":320
 *             if verbose:
 *                 print >> DEBUG_LOG, "Swap node", i, "and", j
 *                 print >> DEBUG_LOG, "Before swapping:", i, "-", m, ",", j, "-", m2             # <<<<<<<<<<<<<<
 *                 print >> DEBUG_LOG, mapping
 ...
 */
        __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 320, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_m2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 320, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_18 = PyTuple_New(8); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 320, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        __Pyx_INCREF(__pyx_kp_s_Before_swapping);
        __Pyx_GIVEREF(__pyx_kp_s_Before_swapping);
        PyTuple_SET_ITEM(__pyx_t_18, 0, __pyx_kp_s_Before_swapping);
        __Pyx_INCREF(__pyx_v_i);
        __Pyx_GIVEREF(__pyx_v_i);
        PyTuple_SET_ITEM(__pyx_t_18, 1, __pyx_v_i);
        __Pyx_INCREF(__pyx_kp_s__2);
        __Pyx_GIVEREF(__pyx_kp_s__2);
        PyTuple_SET_ITEM(__pyx_t_18, 2, __pyx_kp_s__2);
        __Pyx_INCREF(__pyx_v_m);
        __Pyx_GIVEREF(__pyx_v_m);
        PyTuple_SET_ITEM(__pyx_t_18, 3, __pyx_v_m);
        __Pyx_INCREF(__pyx_kp_s__3);
        __Pyx_GIVEREF(__pyx_kp_s__3);
        PyTuple_SET_ITEM(__pyx_t_18, 4, __pyx_kp_s__3);
        __Pyx_INCREF(__pyx_v_j);
        __Pyx_GIVEREF(__pyx_v_j);
        PyTuple_SET_ITEM(__pyx_t_18, 5, __pyx_v_j);
        __Pyx_INCREF(__pyx_kp_s__2);
        __Pyx_GIVEREF(__pyx_kp_s__2);
        PyTuple_SET_ITEM(__pyx_t_18, 6, __pyx_kp_s__2);
        __Pyx_GIVEREF(__pyx_t_8);
        PyTuple_SET_ITEM(__pyx_t_18, 7, __pyx_t_8);
        __pyx_t_8 = 0;
        if (__Pyx_Print(__pyx_t_16, __pyx_t_18, 1) < 0) __PYX_ERR(0, 320, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;

        /* "fast_smatch/_smatch.pyx":321
 *                 print >> DEBUG_LOG, "Swap node", i, "and", j
 *                 print >> DEBUG_LOG, "Before swapping:", i, "-", m, ",", j, "-", m2
 *                 print >> DEBUG_LOG, mapping             # <<<<<<<<<<<<<<
 *                 print >> DEBUG_LOG, "After swapping:", i, "-", m2, ",", j, "-", m
 ...
 */
        __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 321, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_18 = __pyx_convert_vector_to_py_int(__pyx_v_mapping); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 321, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        if (__Pyx_PrintOne(__pyx_t_16, __pyx_t_18) < 0) __PYX_ERR(0, 321, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;

        /* "fast_smatch/_smatch.pyx":322
 *                 print >> DEBUG_LOG, "Before swapping:", i, "-", m, ",", j, "-", m2
 *                 print >> DEBUG_LOG, mapping
 *                 print >> DEBUG_LOG, "After swapping:", i, "-", m2, ",", j, "-", m             # <<<<<<<<<<<<<<
 *             sw_gain = swap_gain(mapping, i, m, j, m2, weight_dict, cur_match_num)
 *             if verbose:
 */
        __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 322, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_18 = __Pyx_PyInt_From_int(__pyx_v_m2); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 322, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        ...
        __pyx_t_18 = 0;
        if (__Pyx_Print(__pyx_t_16, __pyx_t_8, 1) < 0) __PYX_ERR(0, 322, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
 ...
 */
      __pyx_t_15 = __Pyx_PyInt_As_int(__pyx_v_i); if (unlikely((__pyx_t_15 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 323, __pyx_L1_error)
      __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_m); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 323, __pyx_L1_error)
      __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_j); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 323, __pyx_L1_error)
      __pyx_v_sw_gain = swap_gain(__pyx_v_mapping, __pyx_t_15, __pyx_t_14, __pyx_t_4, __pyx_v_m2, __pyx_v_weight_dict, __pyx_v_cur_match_num);

      /* "fast_smatch/_smatch.pyx":324
 *                 print >> DEBUG_LOG, "After swapping:", i, "-", m2, ",", j, "-", m
 *             sw_gain = swap_gain(mapping, i, m, j, m2, weight_dict, cur_match_num)
 *             if verbose:             # <<<<<<<<<<<<<<
 *                 print >> DEBUG_LOG, "Swap gain:", sw_gain
 ...
 *                 new_mapping[i] = m2
 */
        __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 325, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        ...
        PyTuple_SET_ITEM(__pyx_t_18, 0, __pyx_kp_s_Swap_gain);
        __Pyx_GIVEREF(__pyx_t_8);
        PyTuple_SET_ITEM(__pyx_t_18, 1, __pyx_t_8);
        __pyx_t_8 = 0;
        if (__Pyx_Print(__pyx_t_16, __pyx_t_18, 1) < 0) __PYX_ERR(0, 325, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;

        /* "fast_smatch/_smatch.pyx":326
 *             if verbose:
 *                 print >> DEBUG_LOG, "Swap gain:", sw_gain
 *                 new_mapping = mapping[:]             # <<<<<<<<<<<<<<
 *                 new_mapping[i] = m2
 *                 new_mapping[j] = m
 */
        __pyx_t_16 = __pyx_convert_vector_to_py_int(__pyx_v_mapping); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 326, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_18 = __Pyx_PyObject_GetSlice(__pyx_t_16, 0, 0, NULL, NULL, &__pyx_slice__4, 0, 0, 1); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 326, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        if (!(likely(PyBytes_CheckExact(__pyx_t_18))||((__pyx_t_18) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "bytes", Py_TYPE(__pyx_t_18)->tp_name), 0))) __PYX_ERR(0, 326, __pyx_L1_error)
        __Pyx_XDECREF_SET(__pyx_v_new_mapping, ((PyObject*)__pyx_t_18));
        __pyx_t_18 = 0;

        /* "fast_smatch/_smatch.pyx":327
 *                 print >> DEBUG_LOG, "Swap gain:", sw_gain
 *                 new_mapping = mapping[:]
 *                 new_mapping[i] = m2             # <<<<<<<<<<<<<<
 *                 new_mapping[j] = m
 ...
 */
        __pyx_t_18 = __Pyx_PyInt_From_int(__pyx_v_m2); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 327, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        if (unlikely(PyObject_SetItem(__pyx_v_new_mapping, __pyx_v_i, __pyx_t_18) < 0)) __PYX_ERR(0, 327, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;

        /* "fast_smatch/_smatch.pyx":328
 *                 new_mapping = mapping[:]
 *                 new_mapping[i] = m2
 *                 new_mapping[j] = m             # <<<<<<<<<<<<<<
 *                 print >> DEBUG_LOG, new_mapping
 ...
 */
        __pyx_t_18 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 329, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_18);
        if (__Pyx_PrintOne(__pyx_t_18, __pyx_v_new_mapping) < 0) __PYX_ERR(0, 329, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;

        /* "fast_smatch/_smatch.pyx":330
 *                 new_mapping[j] = m
 *                 print >> DEBUG_LOG, new_mapping
 *                 new_match_num = compute_match(new_mapping, weight_dict)             # <<<<<<<<<<<<<<
 *                 if new_match_num != cur_match_num + sw_gain:
 ...
 */
        __pyx_t_17 = __pyx_convert_vector_from_py_int(__pyx_v_new_mapping); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 330, __pyx_L1_error)
        __pyx_v_new_match_num = __pyx_f_11fast_smatch_7_smatch_compute_match(__pyx_t_17, __pyx_v_weight_dict, NULL);

        /* "fast_smatch/_smatch.pyx":331
 *                 print >> DEBUG_LOG, new_mapping
 *                 new_match_num = compute_match(new_mapping, weight_dict)
 *                 if new_match_num != cur_match_num + sw_gain:             # <<<<<<<<<<<<<<
 *                     # print >> ERROR_LOG, match, new_match
 ...
 */
          __pyx_t_18 = __Pyx_GetModuleGlobalName(__pyx_n_s_ERROR_LOG); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 333, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_18);
          __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_cur_match_num); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 333, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_16);
          __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_sw_gain); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 333, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_8);
          __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_new_match_num); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 333, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          __pyx_t_13 = PyTuple_New(4); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 333, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_13);
          __Pyx_INCREF(__pyx_kp_s_Inconsistency_in_computing_swap);
          __Pyx_GIVEREF(__pyx_kp_s_Inconsistency_in_computing_swap);
          PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_kp_s_Inconsistency_in_computing_swap);
          __Pyx_GIVEREF(__pyx_t_16);
          ...
          __pyx_t_8 = 0;
          __pyx_t_7 = 0;
          if (__Pyx_Print(__pyx_t_18, __pyx_t_13, 1) < 0) __PYX_ERR(0, 333, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
          __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
 ...
 *                 use_swap = 1
 */
        __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_i); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 336, __pyx_L1_error)
        __pyx_v_node1 = __pyx_t_4;

        /* "fast_smatch/_smatch.pyx":337
 *                 largest_gain = sw_gain
 *                 node1 = i
 *                 node2 = j             # <<<<<<<<<<<<<<
 *                 use_swap = 1
 ...
 */
        __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_j); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 337, __pyx_L1_error)
        __pyx_v_node2 = __pyx_t_4;

        /* "fast_smatch/_smatch.pyx":338
 *                 node1 = i
 *                 node2 = j
 *                 use_swap = 1             # <<<<<<<<<<<<<<
 *     # generate a new mapping based on swap/move
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_19 = PyTuple_New(2); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 356, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
    __Pyx_INCREF(__pyx_kp_s_Original_mapping);
    __Pyx_GIVEREF(__pyx_kp_s_Original_mapping);
    PyTuple_SET_ITEM(__pyx_t_19, 0, __pyx_kp_s_Original_mapping);
    __Pyx_GIVEREF(__pyx_t_1);
    PyTuple_SET_ITEM(__pyx_t_19, 1, __pyx_t_1);
    __pyx_t_1 = 0;
    if (__Pyx_Print(__pyx_t_2, __pyx_t_19, 1) < 0) __PYX_ERR(0, 356, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

    /* "fast_smatch/_smatch.pyx":357
 *     if verbose:
 *         print >> DEBUG_LOG, "Original mapping", mapping
 *         print >> DEBUG_LOG, "Current mapping", cur_mapping             # <<<<<<<<<<<<<<
 *     return largest_gain
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_19 = __pyx_convert_vector_to_py_int(__pyx_v_cur_mapping); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 357, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_19);
 ...
 */
  ...
  __Pyx_WriteUnraisable("fast_smatch._smatch.get_best_gain", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static void __pyx_f_11fast_smatch_7_smatch_remove_zero_alignments(std::vector<int>  &__pyx_v_mapping, std::unordered_map<int,std::unordered_map<int,int> >  &__pyx_v_weight_dict) {
  PyObject *__pyx_v_i = NULL;
  PyObject *__pyx_v_m = NULL;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_12);
  __Pyx_WriteUnraisable("fast_smatch._smatch.remove_zero_alignments", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_i);
  __Pyx_XDECREF(__pyx_v_m);
  __Pyx_XDECREF(__pyx_v_match_num);
...
static PyObject *__pyx_pw_11fast_smatch_7_smatch_1get_best_match(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11fast_smatch_7_smatch_get_best_match(PyObject *__pyx_v_instance1, PyObject *__pyx_v_attribute1, PyObject *__pyx_v_relation1, PyObject *__pyx_v_instance2, PyObject *__pyx_v_attribute2, PyObject *__pyx_v_relation2, PyObject *__pyx_v_prefix1, PyObject *__pyx_v_prefix2, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_match *__pyx_optional_args) {
  PyObject *__pyx_v_iteration_num = ((PyObject *)__pyx_int_5);

  /* "fast_smatch/_smatch.pyx":391
 * cpdef get_best_match(instance1, attribute1, relation1,
 *                      instance2, attribute2, relation2,
 *                      prefix1, prefix2, iteration_num=5, verbose=False):             # <<<<<<<<<<<<<<
 *     """
 ...
 * 
 */
  __pyx_f_11fast_smatch_7_smatch_compute_pool(__pyx_v_instance1, __pyx_v_attribute1, __pyx_v_relation1, __pyx_v_instance2, __pyx_v_attribute2, __pyx_v_relation2, __pyx_v_prefix1, __pyx_v_prefix2, __pyx_v_candidate_mappings, __pyx_v_weight_dict);

  /* "fast_smatch/_smatch.pyx":419
 *                  prefix1, prefix2, candidate_mappings, weight_dict)
 * 
 *     if verbose:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_v_iteration_num);
  __Pyx_GIVEREF(__pyx_v_iteration_num);
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_iteration_num);
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 431, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (likely(PyList_CheckExact(__pyx_t_3)) || PyTuple_CheckExact(__pyx_t_3)) {
    ...
    __pyx_t_4 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 431, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_6 = Py_TYPE(__pyx_t_2)->tp_iternext; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 431, __pyx_L1_error)
  }
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  for (;;) {
    if (likely(!__pyx_t_6)) {
      if (likely(PyList_CheckExact(__pyx_t_2))) {
        ...
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_3 = PyList_GET_ITEM(__pyx_t_2, __pyx_t_4); __Pyx_INCREF(__pyx_t_3); __pyx_t_4++; if (unlikely(0 < 0)) __PYX_ERR(0, 431, __pyx_L1_error)
        #else
        __pyx_t_3 = PySequence_ITEM(__pyx_t_2, __pyx_t_4); __pyx_t_4++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 431, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        #endif
      } else {
        if (__pyx_t_4 >= PyTuple_GET_SIZE(__pyx_t_2)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_3 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_4); __Pyx_INCREF(__pyx_t_3); __pyx_t_4++; if (unlikely(0 < 0)) __PYX_ERR(0, 431, __pyx_L1_error)
        #else
        __pyx_t_3 = PySequence_ITEM(__pyx_t_2, __pyx_t_4); __pyx_t_4++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 431, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        #endif
 ...
 */
      __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 433, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      if (__Pyx_Print(__pyx_t_3, __pyx_t_7, 1) < 0) __PYX_ERR(0, 433, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_3 = __Pyx_PyInt_EqObjC(__pyx_v_i, __pyx_int_0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 434, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_1 < 0)) __PYX_ERR(0, 434, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (__pyx_t_1) {

      /* "fast_smatch/_smatch.pyx":436
 *         if i == 0:
 *             # smart initialization used for the first round
 *             smart_init_mapping(candidate_mappings, instance1, instance2, cur_mapping)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_f_11fast_smatch_7_smatch_smart_init_mapping(__pyx_v_candidate_mappings, __pyx_v_instance1, __pyx_v_instance2, __pyx_v_cur_mapping);
 ...
 */
    /*else*/ {
      __pyx_f_11fast_smatch_7_smatch_random_init_mapping(__pyx_v_candidate_mappings, __pyx_v_cur_mapping);
    }
    __pyx_L7:;

    /* "fast_smatch/_smatch.pyx":441
 *             random_init_mapping(candidate_mappings, cur_mapping)
 *         # compute current triple match number
 *         match_num = compute_match(cur_mapping, weight_dict)             # <<<<<<<<<<<<<<
 *         if verbose:
 ...
 */
    __pyx_v_match_num = __pyx_f_11fast_smatch_7_smatch_compute_match(__pyx_v_cur_mapping, __pyx_v_weight_dict, NULL);

    /* "fast_smatch/_smatch.pyx":442
 *         # compute current triple match number
 *         match_num = compute_match(cur_mapping, weight_dict)
 *         if verbose:             # <<<<<<<<<<<<<<
 *             print >> DEBUG_LOG, "Node mapping at start", cur_mapping
 ...
 *         while True:
 */
      __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 443, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __pyx_t_7 = 0;
      if (__Pyx_Print(__pyx_t_3, __pyx_t_8, 1) < 0) __PYX_ERR(0, 443, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

      /* "fast_smatch/_smatch.pyx":444
 *         if verbose:
 *             print >> DEBUG_LOG, "Node mapping at start", cur_mapping
 *             print >> DEBUG_LOG, "Triple match number at start:", match_num             # <<<<<<<<<<<<<<
 *         while True:
 *             # get best gain
 */
      __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 444, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __pyx_t_8 = 0;
      if (__Pyx_Print(__pyx_t_3, __pyx_t_7, 1) < 0) __PYX_ERR(0, 444, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *             if verbose:
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_f_11fast_smatch_7_smatch_get_best_gain(__pyx_v_cur_mapping, __pyx_v_candidate_mappings, __pyx_v_weight_dict, __pyx_t_9, __pyx_v_match_num, __pyx_v_new_mapping, NULL)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 447, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_XDECREF_SET(__pyx_v_gain, __pyx_t_3);
      __pyx_t_3 = 0;

      /* "fast_smatch/_smatch.pyx":449
 *             gain = get_best_gain(cur_mapping, candidate_mappings, weight_dict,
 *                                  len(instance2), match_num, new_mapping)
 *             if verbose:             # <<<<<<<<<<<<<<
 *                 print >> DEBUG_LOG, "Gain after the hill-climbing", gain
 ...
 *             if gain <= 0:
 */
        __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_DEBUG_LOG); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 450, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        ...
        if (__Pyx_Print(__pyx_t_3, __pyx_t_7, 1) < 0) __PYX_ERR(0, 450, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      __pyx_t_3 = PyObject_RichCompare(__pyx_v_gain, __pyx_int_0, Py_LE); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 452, __pyx_L1_error)
      __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_1 < 0)) __PYX_ERR(0, 452, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (__pyx_t_1) {

        /* "fast_smatch/_smatch.pyx":453
 *             # hill-climbing until there will be no gain for new node mapping
 *             if gain <= 0:
 *                 break             # <<<<<<<<<<<<<<
 *             # otherwise update match_num and mapping
 ...
 *             if verbose:
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_match_num); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 455, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_7 = PyNumber_InPlaceAdd(__pyx_t_3, __pyx_v_gain); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 455, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_match_num); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 458, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
 ...
 */
        ...
        PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_kp_s_Current_mapping_2);
        __Pyx_GIVEREF(__pyx_t_8);
        PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_t_8);
        __pyx_t_8 = 0;
        if (__Pyx_Print(__pyx_t_7, __pyx_t_3, 1) < 0) __PYX_ERR(0, 459, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 * 
 */
  __pyx_f_11fast_smatch_7_smatch_remove_zero_alignments(__pyx_v_best_mapping, __pyx_v_weight_dict);

  /* "fast_smatch/_smatch.pyx":464
 *             best_match_num = match_num
 *     remove_zero_alignments(best_mapping, weight_dict)
 *     return best_mapping, best_match_num             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __pyx_convert_vector_to_py_int(__pyx_v_best_mapping); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 464, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_7);
  __Pyx_XDECREF(__pyx_t_8);
  __Pyx_AddTraceback("fast_smatch._smatch.get_best_match", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_i);
 ...
 */
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_instance1)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_attribute1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_match", 0, 8, 10, 1); __PYX_ERR(0, 389, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_relation1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_match", 0, 8, 10, 2); __PYX_ERR(0, 389, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_instance2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_match", 0, 8, 10, 3); __PYX_ERR(0, 389, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_attribute2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_match", 0, 8, 10, 4); __PYX_ERR(0, 389, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_relation2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_match", 0, 8, 10, 5); __PYX_ERR(0, 389, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_prefix1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_best_match", 0, 8, 10, 6); __PYX_ERR(0, 389, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_prefix2)) != 0)) kw_args--;
        else {
        ...
        case  8:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_iteration_num);
  ...
  __pyx_r = __pyx_pf_11fast_smatch_7_smatch_get_best_match(__pyx_self, __pyx_v_instance1, __pyx_v_attribute1, __pyx_v_relation1, __pyx_v_instance2, __pyx_v_attribute2, __pyx_v_relation2, __pyx_v_prefix1, __pyx_v_prefix2, __pyx_v_iteration_num, __pyx_v_verbose);
...
static PyObject *__pyx_pf_11fast_smatch_7_smatch_get_best_match(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_instance1, PyObject *__pyx_v_attribute1, PyObject *__pyx_v_relation1, PyObject *__pyx_v_instance2, PyObject *__pyx_v_attribute2, PyObject *__pyx_v_relation2, PyObject *__pyx_v_prefix1, PyObject *__pyx_v_prefix2, PyObject *__pyx_v_iteration_num, PyObject *__pyx_v_verbose) {
  ...
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_11fast_smatch_7_smatch_get_best_match __pyx_t_2;
  __Pyx_RefNannySetupContext("get_best_match", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 2;
  __pyx_t_2.iteration_num = __pyx_v_iteration_num;
  __pyx_t_2.verbose = __pyx_v_verbose;
  __pyx_t_1 = __pyx_f_11fast_smatch_7_smatch_get_best_match(__pyx_v_instance1, __pyx_v_attribute1, __pyx_v_relation1, __pyx_v_instance2, __pyx_v_attribute2, __pyx_v_relation2, __pyx_v_prefix1, __pyx_v_prefix2, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 389, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_11fast_smatch_7_smatch_3clear_match_triple_dict(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyMethodDef __pyx_mdef_11fast_smatch_7_smatch_3clear_match_triple_dict = {"clear_match_triple_dict", (PyCFunction)__pyx_pw_11fast_smatch_7_smatch_3clear_match_triple_dict, METH_NOARGS, 0};
static PyObject *__pyx_pw_11fast_smatch_7_smatch_3clear_match_triple_dict(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("clear_match_triple_dict (wrapper)", 0);
  __pyx_r = __pyx_pf_11fast_smatch_7_smatch_2clear_match_triple_dict(__pyx_self);
...
static PyObject *__pyx_pf_11fast_smatch_7_smatch_2clear_match_triple_dict(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
...
/* Python wrapper */
static PyObject *__pyx_pw_11fast_smatch_7_smatch_5compute_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11fast_smatch_7_smatch_4compute_f[] = "\n    Compute the f-score based on the matching triple number,\n                                 triple number of SIG set 1,\n                                 triple number of SIG set 2\n    Args:\n        match_num: matching triple number\n        test_num:  triple number of SIG 1 (test file)\n        gold_num:  triple number of SIG 2 (gold file)\n        verbose\n    Returns:\n        precision: match_num/test_num\n        recall: match_num/gold_num\n        f_score: 2*precision*recall/(precision+recall)\n    ";
static PyMethodDef __pyx_mdef_11fast_smatch_7_smatch_5compute_f = {"compute_f", (PyCFunction)__pyx_pw_11fast_smatch_7_smatch_5compute_f, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11fast_smatch_7_smatch_4compute_f};
static PyObject *__pyx_pw_11fast_smatch_7_smatch_5compute_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_match_num = 0;
  ...
  __Pyx_RefNannySetupContext("compute_f (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_match_num)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_test_num)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_f", 0, 3, 4, 1); __PYX_ERR(0, 472, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gold_num)) != 0)) kw_args--;
        else {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("fast_smatch._smatch.compute_f", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11fast_smatch_7_smatch_4compute_f(__pyx_self, __pyx_v_match_num, __pyx_v_test_num, __pyx_v_gold_num, __pyx_v_verbose);
...
static PyObject *__pyx_pf_11fast_smatch_7_smatch_4compute_f(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_match_num, PyObject *__pyx_v_test_num, PyObject *__pyx_v_gold_num, PyObject *__pyx_v_verbose) {
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;
    __pyx_t_4 = __pyx_convert_unordered_set_to_py_int((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;
    __pyx_t_4 = __Pyx_PyInt_From_int((__pyx_v_v[__pyx_v_i])); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_1, (PyObject*)__pyx_t_4))) __PYX_ERR(1, 61, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }
...
static PyMethodDef __pyx_methods[] = {
  {"get_best_match", (PyCFunction)__pyx_pw_11fast_smatch_7_smatch_1get_best_match, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11fast_smatch_7_smatch_get_best_match},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fast_smatch__smatch, __pyx_k_fast_smatch__smatch, sizeof(__pyx_k_fast_smatch__smatch), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_smatch(void); /*proto*/
PyMODINIT_FUNC init_smatch(void)
#else
PyMODINIT_FUNC PyInit__smatch(void); /*proto*/
PyMODINIT_FUNC PyInit__smatch(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__smatch(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_fast_smatch___smatch) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_smatch._smatch")) {
      if (unlikely(PyDict_SetItemString(modules, "fast_smatch._smatch", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     pass
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11fast_smatch_7_smatch_3clear_match_triple_dict, NULL, __pyx_n_s_fast_smatch__smatch); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 467, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     Compute the f-score based on the matching triple number,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11fast_smatch_7_smatch_5compute_f, NULL, __pyx_n_s_fast_smatch__smatch); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 472, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute_f, __pyx_t_1) < 0) __PYX_ERR(0, 472, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "fast_smatch/_smatch.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fast_smatch._smatch", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fast_smatch._smatch");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
