...
def parse_relations(rels, v2c):
	...
	for v in var_list:
		...
		k += 1
	return sig.SIG(var_list, conc_list, rel_dict, att_dict)
...
def main(list1, list2):
    ...
    for l1, l2 in zip(list1,list2):
        lst_sig1, dic_sig1 = l1
        lst_sig2, dic_sig2 = l2
	sig1 = parse_relations(lst_sig1, dic_sig1)
        sig2 = parse_relations(lst_sig2, dic_sig2)
	prefix1 = "a"
        prefix2 = "b"
